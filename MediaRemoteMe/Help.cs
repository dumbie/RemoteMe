    ...
    partial class MainPage
    {
        ...
        void HelpLoad()
        {
            try
            {
                ...
                {
                    sp_Help.Children.Add(new TextBlock() { Text = "How do I setup RemoteMe?", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    ...
                    sp_Help.Children.Add(new TextBlock() { Text = "When you are walking into any problems or a bug you can go to my help page at https://help.arnoldvink.com so I can try to help you out and get everything working.", Style = (Style)App.Current.Resources["TextBlockLightGray"], TextWrapping = TextWrapping.Wrap });

                    sp_Help.Children.Add(new TextBlock() { Text = "\r\nDeveloper donation", Style = (Style)App.Current.Resources["TextBlockBlack"] });
                    sp_Help.Children.Add(new TextBlock() { Text = "If you appreciate my project and want to support me with my projects you can make a donation through https://donation.arnoldvink.com", Style = (Style)App.Current.Resources["TextBlockLightGray"], TextWrapping = TextWrapping.Wrap });
