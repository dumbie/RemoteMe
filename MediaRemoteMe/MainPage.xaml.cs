    ...
    public partial class MainPage : Page
    {
        ...
        async Task ApplicationNavigation()
        {
            try
            {
                ...
                //Tile Startup
                if (App.vLaunchTileActivatedCommand == "MediaRemoteMePlayPause") { await SocketSendArnold("MePlayPause"); }
                else if (App.vLaunchTileActivatedCommand == "MediaRemoteMePrevious") { await SocketSendArnold("MePrevSong"); }
                else if (App.vLaunchTileActivatedCommand == "MediaRemoteMeNext") { await SocketSendArnold("MeNextSong"); }
                else if (App.vLaunchTileActivatedCommand == "MediaRemoteMeVolUp") { await SocketSendArnold("MeVolUp" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchTileActivatedCommand == "MediaRemoteMeVolDown") { await SocketSendArnold("MeVolDown" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchTileActivatedCommand == "MediaRemoteMeVolMute") { await SocketSendArnold("MeVolMute"); }
                ...
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMePause") { await SocketSendArnold("MePlayPause"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeStop") { await SocketSendArnold("MePlayPause"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMePrevious") { await SocketSendArnold("MePrevSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeBack") { await SocketSendArnold("MePrevSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeLeft") { await SocketSendArnold("MePrevSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeNext") { await SocketSendArnold("MeNextSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeForward") { await SocketSendArnold("MeNextSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeRight") { await SocketSendArnold("MeNextSong"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolUp") { await SocketSendArnold("MeVolUp" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolUpShort") { await SocketSendArnold("MeVolUp" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolDown") { await SocketSendArnold("MeVolDown" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolDownShort") { await SocketSendArnold("MeVolDown" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolMute") { await SocketSendArnold("MeVolMute"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolMuteShort") { await SocketSendArnold("MeVolMute"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolUnmute") { await SocketSendArnold("MeVolMute"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeVolUnmuteShort") { await SocketSendArnold("MeVolMute"); }
                else if (App.vLaunchVoiceActivatedCommand == "MediaRemoteMeArrowLeft") { await SocketSendArnold("MeArrowLeft"); }
                ...
                else if (App.vApplicationLaunchArgs == "NfcNext") { await SocketSendArnold("MeNextSong"); }
                else if (App.vApplicationLaunchArgs == "NfcVolUp") { await SocketSendArnold("MeVolUp" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vApplicationLaunchArgs == "NfcVolDown") { await SocketSendArnold("MeVolDown" + vApplicationSettings["VolSkip"].ToString()); }
                else if (App.vApplicationLaunchArgs == "NfcVolMute") { await SocketSendArnold("MeVolMute"); }
        ...
        void menuButtonRemote_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            tab_Monitor.Visibility = Visibility.Collapsed;
            menuButtonMonitor.Background = new SolidColorBrush(Colors.Transparent);

            tab_AmbiPro.Visibility = Visibility.Collapsed;
            menuButtonAmbiPro.Background = new SolidColorBrush(Colors.Transparent);
        ...
        void menuButtonMonitor_Tapped(object sender, TappedRoutedEventArgs e)
        {
            tab_Remote.Visibility = Visibility.Collapsed;
            menuButtonRemote.Background = new SolidColorBrush(Colors.Transparent);
            ...
            tab_Monitor.Visibility = Visibility.Visible;
            menuButtonMonitor.Background = new SolidColorBrush(Color.FromArgb(20, 255, 255, 255));
        ...
        void menuButtonAmbiPro_Tapped(object sender, TappedRoutedEventArgs e)
        {
            tab_Remote.Visibility = Visibility.Collapsed;
            menuButtonRemote.Background = new SolidColorBrush(Colors.Transparent);
            ...
            tab_AmbiPro.Visibility = Visibility.Visible;
            menuButtonAmbiPro.Background = new SolidColorBrush(Color.FromArgb(20, 255, 255, 255));
